...
SECRET_KEY = os.getenv('SECRET_KEY', 'comment-service-secret-key-2024')
DEBUG = True
ALLOWED_HOSTS = ['*']
INSTALLED_APPS = [
    'django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
    'django.contrib.sessions', 'django.contrib.messages', 'django.contrib.staticfiles',
    'rest_framework', 'corsheaders', 'comments',
]
MIDDLEWARE = [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'comment_db'),
        'USER': os.getenv('DB_USER', 'root'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'paperrose'),
