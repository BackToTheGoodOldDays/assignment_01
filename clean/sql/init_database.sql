-- =====================================================
-- SQL Script for Clean Architecture Bookstore Database
-- Database: bookstore_clean
-- =====================================================

-- Create database
CREATE DATABASE IF NOT EXISTS bookstore_clean CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE bookstore_clean;
